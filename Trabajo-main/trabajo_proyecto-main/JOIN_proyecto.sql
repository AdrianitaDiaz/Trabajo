...
11. SELECT habitacion.id_habitacion, habitacion.id_huesped, habitacion.piso, habitacion.numero, habitacion.tipo_habitacion, habitacion.disponibilidad, habitacion.reserva
FROM habitacion
FULL OUTER JOIN habitacion.id_huesped As habitacion.numero ON habitacion.id_habitacion =  habitacion.reserva;

12. SELECT transaccion.id_transaccion_bancaria, id_reserva, id_efectivo, id_met_pago, transaccion.tipo
FROM transaccion As reserva 
INNER JOIN id_reserva As transaccion.tipo ON transaccion.id_efectivo = transaccion.valor;
